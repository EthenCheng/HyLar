...
class ActorConfig:
    ...
    hylar_rl_kappa: float = 10.0
    # ===== D-1: Decoupled Hybrid PPO parameters =====
    latent_clip_ratio_low: float = 0.2
    """PPO clip ratio lower bound for latent positions (recommended tighter than token)"""
    latent_clip_ratio_high: float = 0.28
    """PPO clip ratio upper bound for latent positions (recommended tighter than token)"""
    ...
    # ===== D-2: Closed-form vMF KL constraint parameters =====
    ...
    """disable standard PPO KL penalty term KL[π_θ || π_ref]; set to True to remove this term from loss"""
