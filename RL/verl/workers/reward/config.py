...
class RewardConfig:
    ...
    repetition_penalty: bool = False  # Deprecated: kept for compatibility but will be ignored
    """auto keys"""
...
class RuleBasedJudgeConfig:
    ...
    api_name: str = "gpt-5"
    api_url: Optional[str] = None  # For local model deployment (e.g., vLLM with OpenAI-compatible API)
    api_kwargs: dict = field(default_factory=dict)
    api_max_workers: int = 32  # Maximum number of concurrent API workers for batch judging
